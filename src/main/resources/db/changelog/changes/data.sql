...
INSERT INTO message (id, section_id, sender, text, callback_text, wait_for, "order") VALUES
    ...
    (2,  2, 'ANYA', 'Теперь установи редактор — IntelliJ IDEA. Изучи материал и дай знать.', 'Готово', 'CALLBACK', 1),
    -- block1 / topic3 / теория
    (3,  3, 'ANYA', 'Создай первый проект и запусти Hello World. Изучи материал и дай знать.', 'Готово', 'CALLBACK', 1),
    -- block2 / topic1 / теория
    (4,  4, 'ANYA', 'Новый спринт — разберёмся с примитивами и базовыми типами. Это справочник, не нужно заучивать — просто пробегись.', 'Готово', 'CALLBACK', 1),
    -- block2 / topic1 / задание
    (5,  5, 'ANYA', 'Открой класс QuestB2T1 в репозитории и реши задания. Когда всё готово — создай Pull Request.', null, 'PR', 1),
    (6,  5, 'BOT',  'PR получен, проверяю...', null, 'NOTHING', 2),
    -- block2 / topic2 / теория
    (7,  6, 'ANYA', 'Переходим к синтаксису. Изучи материал и дай знать.', 'Готово', 'CALLBACK', 1),
    -- block2 / topic2 / задание
    (8,  7, 'ANYA', 'Открой класс QuestB2T2 в репозитории и реши задания. Когда всё готово — создай Pull Request.', null, 'PR', 1),
    (9,  7, 'BOT',  'PR получен, проверяю...', null, 'NOTHING', 2),
    -- block2 / topic3 / теория
    (10, 8, 'ANYA', 'Последний материал в этом спринте — соглашения об именовании. Изучи и дай знать.', 'Готово', 'CALLBACK', 1);
