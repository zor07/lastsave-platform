...
Создай ветку, запушь, открой PR в main. После ревью замержи, подтяни main локально, удали ветку.', NULL, 'PR', 1),
...
Реализуй задачи в пакете block05/topic01. Создай ветку, запушь, открой PR в main. После ревью замержи, подтяни main локально, удали ветку.', NULL, 'PR', 1),
...
Реализуй задачи в пакете block05/topic02. Создай ветку, запушь, открой PR в main. После ревью замержи, подтяни main локально, удали ветку.', NULL, 'PR', 1),
...
Реализуй задачи в пакете block05/topic03. Создай ветку, запушь, открой PR в main. После ревью замержи, подтяни main локально, удали ветку.', NULL, 'PR', 1),
...
Реализуй задачи в пакете block05/topic04. Создай ветку, запушь, открой PR в main. После ревью замержи, подтяни main локально, удали ветку.', NULL, 'PR', 1),
...
Реализуй задачи в пакете block05/topic05. Создай ветку, запушь, открой PR в main. После ревью замержи, подтяни main локально, удали ветку.', NULL, 'PR', 1),
